    ...
    <>
      ...
      <div className="fixed lg:hidden z-[1000] flex bottom-0 left-0 right-0 bg-white border-t-[1px] border-gray-200 text-white justify-around items-end pb-1 shadow-lg shadow-gray-500">
            ...
            !item?.hidden && (
              ...
              >
                ...
                >
                  {item.isCenter ? (
                    <div className="bg-yellow-500 flex justify-center p-[6px] rounded-full text-black items-center">
                      <div className="bg-yellow-500">
                        <span className="animate-spin-slow text-[18px]">
                          {item.icon}
                        </span>
                      </div>
                    </div>
                  ...
                  <span className="text-[12px] font-[500] mt-2">
                    {item.label}
                  </span>
                </button>
        ...
        {activeTab === "bet_slip" && bet_slipopen && (
          <div className="w-full fixed z-[-1] bottom-0 left-0 bg-red-50 h-[300px]"></div>
        )}
          ...
          <div className="bg-white fixed top-0 left-0 w-full  text-gray-800 h-[100vh] overflow-y-auto no-scrollbar shadow-lg">
            ...
            <div className="flex items-center justify-between p-4 border-b border-gray-300">
              ...
              <div className="flex space-x-2">
                <button
                  onClick={handlealert}
                  className="p-3 hover:bg-gray-200 text-gray-800 rounded-[5px] bg-gray-200"
                >
                  <FaCog size={18} />
                </button>
                <button
              ...
              <div className="space-y-4 px-4 py-[10px] border-b-[1px] border-gray-200">
                ...
                <div className="grid grid-cols-2 gap-[6px]">
                  <button
                    ...
                    className="flex items-center justify-center space-x-2 font-[500] bg-[#FFB805] text-black p-2 rounded-[5px]"
                  >
                    <FaGooglePlay />
                    <span>ANDROID</span>
                  </button>
