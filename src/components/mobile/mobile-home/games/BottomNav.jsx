...
import { FaBars, FaFutbol, FaRegUser, FaTimes, FaDice, FaAppleAlt, FaChevronDown, FaUserCircle } from "react-icons/fa";
...
import { FaGooglePlay, FaAppStoreIos, FaTv, FaHome, FaStar, FaTrophy, FaMoneyBill, FaGamepad, FaCog } from "react-icons/fa";
...
const BottomNav = () => {
  ...
  const navItems = [
    ...
    { id: "livecasino", label: "Live casino", icon: <MdCasino />, href: "livecasino" },

    { id: "leaderboard", label: "Leaderboard", icon: <FaTrophy />, href: "leaderboard" },

    { id: "profile", label: "Profile", icon: <FaUserCircle />, href: "profile", hidden: user ? true : false },
  ...
  return (
    <>
      ...
      <div className="fixed lg:hidden z-[1000] flex bottom-0 left-0 right-0 bg-white border-t-[1px] border-gray-200 text-white justify-around items-end pb-1 shadow-lg shadow-gray-500">
          ...
          (item) =>
            !item?.hidden && (
              <NavLink to={item.href ? item.href : ""} key={item.id} className="relative">
                <button
                  className={`relative flex flex-col items-center cursor-pointer px-2 lg:px-4 py-1 ${activeTab === item.id ? "text-yellow-400" : "text-gray-500"} transition-all`}
                  onClick={() => {
                ...
                {item.id === "casino" && casinoOpen && (
                  <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 bg-white shadow-lg rounded-t-[10px] py-3 px-[4px] transition-all duration-300 ease-in-out">
                    <ul className="flex flex-col items-center space-y-3">
                      ...
                      <button className="flex justify-center items-center cursor-pointer w-full text-gray-500 hover:text-gray-800 transition-all" onClick={() => setCasinoOpen(false)}>
                ...
                {item.id === "sport" && sportsopen && (
                  <div className="absolute bottom-0 left-1/2 ml-[10px] transform -translate-x-1/2 bg-white shadow-lg rounded-t-[10px] py-3 px-[10px] transition-all duration-300 ease-in-out">
                    <ul className="flex flex-col items-center space-y-3">
                      ...
                      <button className="flex justify-center items-center cursor-pointer w-full text-gray-500 hover:text-gray-800 transition-all" onClick={() => setsportsopen(false)}>
                        <CgClose className="text-[22px]" />
                      </button>
                    </ul>
        ...
        {activeTab === "bet_slip" && bet_slipopen && <div className="w-full fixed z-[-1] bottom-0 left-0 bg-red-50 h-[300px]"></div>}
          ...
          <div className="bg-white fixed top-0 left-0 w-full  text-gray-800 h-[100vh] overflow-y-auto no-scrollbar shadow-lg">
            ...
            <div className="flex items-center justify-between p-4 border-b border-gray-300">
              ...
              <div className="relative">
                <button onClick={() => setIsLanguageOpen(!isLanguageOpen)} className="px-3 py-1 rounded-lg flex items-center space-x-2">
              ...
              <div className="flex space-x-2">
                <button onClick={handlealert} className="p-3 hover:bg-gray-200 text-gray-800 rounded-[5px] bg-gray-200">
                  <FaCog size={18} />
                </button>
                <button
                  onClick={() => {
            ...
            <div className="w-full  space-y-2">
              ...
              <div className="space-y-2">
                <NavLink
                  ...
                  className="flex items-center space-x-2 w-full p-2 border-b-[1px] border-gray-200 hover:bg-gray-200">
                  <span className="p-[10px] text-[20px] bg-gray-100 rounded-full">
                    <FaHome />
                  </span>
                  <span>Main Page</span>
                </NavLink>
                ...
                <button onClick={handlealert} className="flex items-center space-x-2 w-full p-2 border-b-[1px] border-gray-200 hover:bg-gray-200">
                  <span className="p-[10px] text-[13px] bg-gray-100 rounded-full text-green-500 animate-pulse flex justify-center items-center">
                    ( <GoDotFill /> )
                  </span>
                  <span>Live</span>
                </button>
                ...
                <button onClick={handlealert} className="flex items-center space-x-2 w-full p-2 border-b-[1px] border-gray-200 hover:bg-gray-200">
                  <span className="w-[27px] h-[27px] flex justify-center items-center bg-green-600 rounded-full">
                    <span className="w-[16px] h-[16px] bg-red-500 rounded-full"></span>
                  </span>
                ...
                <button onClick={handlealert} className="flex items-center space-x-2 w-full p-2 border-b-[1px] border-gray-200 hover:bg-gray-200">
                  <span className="p-[10px] text-[20px] bg-gray-100 text-orange-500 rounded-full">
                    <IoIosStar />
                  </span>
