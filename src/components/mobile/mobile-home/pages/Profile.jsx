      ...
      <div className="w-full px-[10px] py-[10px] pb-[50px] min-h-[80vh] bg-gray-100 overflow-hidden">
        ...
        <div className="bg-white  p-3 mb-[15px] rounded-[5px] ">
          ...
          <div className="flex gap-[10px]">
            <button className="w-1/2 py-2 text-[14px] text-white bg-[#2E2E2E] rounded-[5px] font-medium">
              My bets
            </button>
            <NavLink
              to="/deposit"
              className="w-1/2 py-2 text-[14px] text-center text-white bg-[#FFB805]  rounded-[5px] font-medium"
            >
              Deposit
            </NavLink>
          </div>
          ...
          {["Profile", "Promo", "Settings"].map((tab) => (
            <button
              ...
              className={`flex-1 py-3 text-sm cursor-pointer font-medium ${
                activeTab === tab
                  ? "border-b-3 border-yellow-500 text-gray-800"
                  : "text-gray-500"
              }`}
        ...
        <div className="p-4 bg-white">
          {activeTab === "Profile" && (
            <>
              {/* Account Section */}
              <p className="text-gray-500 text-[14px]  font-semibold mb-3">
                ACCOUNT
              </p>
              <div className="space-y-4">
                <div className="flex items-center gap-3 text-gray-700">
                  <NavLink to="/leaderboard" className="mt-[10px]">
                    <FaHistory className="text-lg" /> Bet history
                  </NavLink>
                </div>
                <NavLink to="/deposit" className="mt-[10px]">
                  <div className="flex items-center gap-3 text-gray-700">
                    <FaDownload className="text-lg" /> Make a deposit
                  </div>
                </NavLink>
                <NavLink to="/deposit">
                  <div className="flex items-center gap-3 mt-[12px] text-gray-700">
                    <FaUpload className="text-lg" /> Withdraw funds
                  </div>
                </NavLink>

                <NavLink to="/profile/transaction-history">
                  <div className="flex items-center gap-3 mt-[12px] text-gray-700">
                    <FaExchangeAlt className="text-lg" /> Transaction history
                  </div>
                </NavLink>
              </div>

              {/* Profile Section */}
              <p className="text-gray-500 text-xs font-semibold mt-5 mb-2">
                PROFILE
              </p>
              <div className="space-y-3">
                <div className="flex items-center gap-3  text-gray-700">
                  <FaUser className="text-lg" /> Personal profile{" "}
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3  text-gray-700">
                  <FaUsers className="text-lg" /> Invite friends
                </div>
                <div
