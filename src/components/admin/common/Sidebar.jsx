  ...
  const SIDEBAR_ITEMS = [
    ...
    },
    {
      ...
      submenu: [
        {
          name: "Active User",
          href: "/admin-dashboard/active-users",
          count: active_user,
        },
        {
          name: "Deactive User",
          href: "/admin-dashboard/deactive-users",
          count: inactive_user,
        },
    ...
    },
    {
      ...
      submenu: [
        ...
        },
        {
          ...
          href: "/admin-dashboard/pending-deposits",
          count: pending_deposit,
        },
      ],
    },
    {
      ...
      submenu: [
        ...
        { name: " All Acctive Account", href: "/users/all-user" },
        {
          ...
          href: "/admin-dashboard/all-withdarwal",
          count: all_withdraw,
        },
        {
          name: "Withdraw Request ",
          href: "/admin-dashboard/pending-withdarwal",
          count: pending_withdraw,
        },
      ],
    },
    {
      ...
      <div className="no-scrollbar  h-full overflow-y-auto bg-[#071251] custom-scrollbar backdrop-blur-md px-[10px] py-4 flex flex-col ">
        ...
        >
          <div className="py-4 ">
            ...
            {isSidebarOpen ? (
              <h1 className="text-white text-[20px] font-[600] text-nowrap">
                Mothers Admin
              </h1>
            ) : (
              ""
          ...
          {SIDEBAR_ITEMS.map((item, index) => (
            <div key={index}>
              {item.submenu ? (
                ...
                <Link
                  to={item.href}
                  className="flex items-center hover:bg-yellow-500  hover:text-black px-[10px] py-[10px]  text-sm font-medium rounded-lg  transition-colors mb-2"
                >
                  <item.icon
                    size={20}
                    style={{ color: item.color, minWidth: "20px" }}
